 ...
 * @method static \Illuminate\Database\Eloquent\Builder<static>|User filter(\Caleb\Practice\QueryFilter $filter)
 ...
 * @method static \Illuminate\Database\Eloquent\Builder<static>|User whereIsSuper($value)
...
class User extends Authenticatable
{
    ...
    use HasFactory, Notifiable, Standardization, HasApiTokens, SoftDeletes;
